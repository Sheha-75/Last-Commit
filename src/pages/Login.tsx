...
import { Mail, Lock, Eye, EyeOff, ShieldCheck, Fingerprint, LockKeyhole, ScanFace } from 'lucide-react';
...
export default function Login() {
  ...
  const [email, setEmail] = useState('analyst@sentinelshield.io');
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-soc-bg">
      ...
      <div className="absolute -bottom-40 -right-40 w-[480px] h-[480px] rounded-full bg-soc-accent/20 blur-[120px]" />

      <div className="relative z-10 min-h-screen grid lg:grid-cols-2">
        {/* Left — branding / animated illustration */}
        <div className="hidden lg:flex flex-col justify-between p-12">
          <div className="flex items-center gap-3">
            <ShieldLogo size={48} />
            <div>
              <h1 className="text-xl font-bold tracking-tight text-white">SentinelShield <span className="text-soc-accent">AI</span></h1>
          ...
          <div className="relative max-w-md">
            ...
            >
              <h2 className="text-4xl font-extrabold leading-tight text-white">
                ...
                <span className="text-glow text-soc-accent">financial frontier</span>
              </h2>
              <p className="mt-4 text-slate-400 leading-relaxed">
                AI-powered fraud detection, real-time threat intelligence, and autonomous response for enterprise banks.
              </p>
            </motion.div>

            {/* Animated cyber illustration */}
            <div className="relative mt-10 h-64">
              ...
              >
                <div className="flex items-center gap-2 text-soc-accent text-xs font-semibold">
        ...
        <div className="flex items-center justify-center p-6 sm:p-12">
          ...
          >
            <div className="lg:hidden flex items-center gap-3 mb-8">
              <ShieldLogo size={44} />
              <div>
                <h1 className="text-lg font-bold text-white">SentinelShield <span className="text-soc-accent">AI</span></h1>
                <p className="text-[11px] text-slate-400">Financial SOC</p>
              </div>
            </div>

            <h2 className="text-2xl font-bold text-white">Secure Sign In</h2>
            <p className="mt-1 text-sm text-slate-400">Access the security operations console</p>

            <form onSubmit={onSubmit} className="mt-8 space-y-5">
              <div>
                <label className="text-xs font-medium text-slate-300">Analyst Email</label>
                <div className="mt-1.5 relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-soc-card2 border border-soc-border pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:border-soc-accent focus:ring-2 focus:ring-soc-accent/30 outline-none transition"
                    placeholder="analyst@bank.io"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1.5 relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-soc-card2 border border-soc-border pl-10 pr-10 py-2.5 text-sm text-white placeholder-slate-500 focus:border-soc-accent focus:ring-2 focus:ring-soc-accent/30 outline-none transition"
                    placeholder="••••••••"
                    required
                  />
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-xs text-soc-accent hover:underline">Forgot password?</a>
              </div>
